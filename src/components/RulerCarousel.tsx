...
export function RulerCarousel({
  ...
  const targetX = -120 + (centerPosition - (activeIndex % itemsPerSet)) * 120;
          ...
          {infiniteItems.map((item, index) => {
            ...
            return (
              <motion.button
                ...
                className={`text-sm md:text-base font-medium whitespace-nowrap cursor-pointer flex items-center justify-center ${
                  isActive
                    ? "text-white"
