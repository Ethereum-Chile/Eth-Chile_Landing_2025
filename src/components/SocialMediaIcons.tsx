...
const SocialMediaIcons: React.FC = () => {
  return (
    <div className="flex justify-center items-center space-x-8 mt-2">
      ...
      {/* GitHub */}
      <a
        href="https://github.com/Ethereum-Chile"
        target="_blank"
        rel="noopener noreferrer"
        className="group"
      >
        <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-white/50 group-hover:bg-gray-800 border border-white/20">
          <svg
            className="w-8 h-8 text-white"
            fill="currentColor"
            viewBox="0 0 24 24"
